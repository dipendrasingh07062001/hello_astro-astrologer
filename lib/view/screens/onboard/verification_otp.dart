...
class _VerificationState extends State<Verification> {
  ...
  late double h, w;
  String lastTwoDigit = mobNumber.substring(8, 10);
              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        textStyle('Phone Number ', AppColor.colLabel, w * .043,
                            FontWeight.w500),
                        textStyle('xxxxxxxx', AppColor.colPrimary, w * .043,
                            FontWeight.w500),
                        textStyle(lastTwoDigit, AppColor.colPrimary, w * .043,
                            FontWeight.w500),
                      ],
                    ),
                  ],
                        ...
                        decoration: InputDecoration(
                          ...
                          focusedBorder: OutlineInputBorder(
                            borderSide: BorderSide(
                                width: w * .0044, color: AppColor.colPrimary),
                            borderRadius:
                ...
                Row(
                  ...
                  children: [
                    ...
                    InkWell(
                      ...
                      onTap: () {
                        // onboardingController.resendSignupApi(widget.phone);
                      },
                    ),
                  ],
                ),
                      ...
                      : EltdButton(
                          ...
                          press: () {
                            ...
                            if (first.text.isNotEmpty &&
                              ...
                              // onboardingController.veriifyApi(
                              //     widget.phone, sub);
                            } else {
                              Get.rawSnackbar(
